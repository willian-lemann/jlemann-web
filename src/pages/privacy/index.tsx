...
const Privacy: React.FC = () => {
   return (
      <div className={styles.privacyContainer}>
         ...
         <main>
            <h1>Política de privacidade da Jlemann Corretora</h1>
            <p>
               ...
               Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em jlemanncorretora@hotmail.com ou nos enviando uma correspondência em: Jlemann Corretora Rua Manoel Araujo, 50, Imbituba
